<template>
  <div>
    <nav class="navbar navbar-expand-md navbar-dark fixed-top bg-dark flex-md-nowrap p-0 shadow">
      <router-link class="navbar-brand bg-dark col-sm-3 col-md-2 mr-0" to="/front/home">
      ...
      <ul class="navbar-nav ml-auto px-3">        
        <li class="nav-item text-nowrap">
          <router-link to="/login" class="nav-link" href="#" >
            <i class="fas fa-sign-in-alt text-light mr-2"></i>Sign in
          </router-link>           
        </li>
        <li class="nav-item text-nowrap">
          <a class="nav-link" href="#" @click.prevent="signout">
            <i class="fas fa-sign-out-alt text-light mr-2"></i>Sign out
          </a>             
        </li>
      </ul>
    </nav>
